            ...
            <form action="" method="POST" class="form col-12 col-md-8 col-lg-6  mx-auto bg-white shadow-sm p-3 rounded border border-secondary ">
                ...
                <div class="form-group mb-2 mt-2 d-flex">
                    ...
                    <div class="d-flex flex-column w-75">
                        <input type="email" class="form-control" name="email" id="email" placeholder="Veuiller taper l'email" value="<?php if(isset($_POST['email'])) echo $_POST['email'] ?>"required/>
                ...
                <div class="row no-gutters">
                    <input type="submit" value="Envoyer" class="btn btn-primary btn-block col-11 mx-auto border-rounded">
                </div>
